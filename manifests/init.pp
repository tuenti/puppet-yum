...
#
class yum (
  $install_all_keys     = $yum::params::install_all_keys,
  $update               = $yum::params::update,
  $update_disable       = $yum::params::update_disable,
  $defaultrepo          = $yum::params::defaultrepo,
  $extrarepo            = $yum::params::extrarepo,
  $plugins_config_dir   = $yum::params::plugins_config_dir,
  $repo_dir             = $yum::params::repo_dir,
  $source_repo_dir      = $yum::params::source_repo_dir,
  $clean_repos          = $yum::params::clean_repos,
  $my_class             = $yum::params::my_class,
  $source               = $yum::params::source,
  $source_dir           = $yum::params::source_dir,
  $source_dir_purge     = $yum::params::source_dir_purge,
  $template             = $yum::params::template,
  $options              = $yum::params::options,
  $absent               = $yum::params::absent,
  $disable              = $yum::params::disable,
  $disableboot          = $yum::params::disableboot,
  $puppi                = $yum::params::puppi,
  $puppi_helper         = $yum::params::puppi_helper,
  $debug                = $yum::params::debug,
  $audit_only           = $yum::params::audit_only,
  $config_dir           = $yum::params::config_dir,
  $config_file          = $yum::params::config_file,
  $config_file_mode     = $yum::params::config_file_mode,
  $config_file_owner    = $yum::params::config_file_owner,
  $config_file_group    = $yum::params::config_file_group,
  $update_template      = $yum::params::update_template,
  $cron_param           = $yum::params::cron_param,
  $cron_mailto          = $yum::params::cron_mailto,
  $cron_dotw            = $yum::params::cron_dotw,
  $cron_clean_dotw      = $yum::params::cron_clean_dotw,
  $cron_update_cmd      = $yum::params::cron_update_cmd,
  $cron_update_messages = $yum::params::cron_update_messages,
  $cron_apply_updates   = $yum::params::cron_apply_updates,
  $cron_random_sleep    = $yum::params::cron_random_sleep,
  $cron_emit_via        = $yum::params::cron_emit_via,
  $cron_email_host      = $yum::params::cron_email_host,
  $log_file             = $yum::params::log_file,
  $manage_persist_dir   = $yum::params::manage_persist_dir,
  $persist_dir          = $yum::params::persist_dir,
  $manage_cache_dir     = $yum::params::manage_cache_dir,
  $cache_dir            = $yum::params::cache_dir,
  $priorities_plugin    = $yum::params::priorities_plugin
  ) inherits yum::params {
